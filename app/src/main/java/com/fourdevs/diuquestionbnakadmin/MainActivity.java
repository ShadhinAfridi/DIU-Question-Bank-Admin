...
import com.fourdevs.diuquestionbnakadmin.databinding.ActivityMainBinding;
...
public class MainActivity extends BaseActivity {
    ...
    private void setListeners() {
        ...
        binding.cardUser.setOnClickListener(view -> {
        ...
        binding.cardApprove.setOnClickListener(view -> {
            Intent intent = new Intent(MainActivity.this, ApproveQuestionActivity.class);
            startActivity(intent);
        });
    }
