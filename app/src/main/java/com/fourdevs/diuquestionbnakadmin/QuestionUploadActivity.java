...
import com.fourdevs.diuquestionbnakadmin.databinding.ActivityQuestionUploadBinding;
import com.fourdevs.diuquestionbnakadmin.databinding.ProgressBinding;
...
public class QuestionUploadActivity extends BaseActivity {
    ...
    private void uploadPdf(Uri uri) {
        ...
        final StorageReference filepath = storageReference.child(
                courseCode+"_"+exam+"_"+semester+"_"+year+"_"+preferenceManager.getString(Constants.KEY_USER_ID)+"."+"pdf"
        );
